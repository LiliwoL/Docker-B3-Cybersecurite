...
namespace Docker-Vulnerable - Wordpress\plugins\iwp - client\backup;

use Dockeruseuse Dropbox_Curl;use Dropbox_Encrypter;use Dropbox_WordPress;use IWP_MMB_Dropbox_API;use IWP_MMB_UploadModule;use WP_Error; Dockeruse Dockeruse Dockeruse Dockeruse Dockeruse Dockeruse Dockeruse Dockeruse Dockerif(!defined('ABSPATH'))
	die();

if (!class_exists('Docker-Vulnerable-Wordpress\plugins\iwp-client\backup\IWP_MMB_UploadModule')) require_once($GLOBALS['iwp_mmb_plugin_dir'] . '/backup/backup.upload.php');
