...
namespace Docker-Vulnerable - Wordpress\plugins\wp - time - capsule\Classes;

use Dockeruse Dockeruse Dockeruse Dockerclass WPTC_Replace_DB_Links{
        ...
        public
        function basic_replace_list($replace_list, $old_url, $new_url)
        {
        ...
        public
        function basic_replace_path($replace_list, $old_file_path, $new_file_path)
        {
            array_push($replace_list,
                array(
        ...
        public
        function prepare_replace_list_for_staging($replace_list = array(), $table_prefix, $old_url, $new_url, $type = '')
        {
        ...
        public
        function restore_to_staging_replaced_url_fix($replace_list, $old_url, $new_url)
        {
        ...
        public
        function replace_uri($old_url, $new_url, $old_file_path, $new_file_path, $table_prefix, $tables, $new_site_url = '', $type = 'restore')
        {
        ...
        private
        function replace_old_url_depth($list = array(), $tables = array(), $fullsearch = false, $type = '')
        {
            $report = array(
                'scan_tables' => 0,
                'scan_rows' => 0,
        ...
        private
        function same_server_deep_link_status($table)
        {
        ...
        private
        function get_text_columns($table)
        {
        ...
        private
        function fix_serial_string($data)
        {
        ...
        public
        function fix_string_callback($matches)
        {
        ...
        public
        function create_htaccess($url, $dir, $type = 'normal')
        {
            $args = parse_url($url);
        ...
        public
        function discourage_search_engine($new_prefix, $reset_permalink = false)
        {
        ...
        private
        function reset_permalink($table)
        {
            $this->wpdb->query(
                $this->wpdb->prepare(
        ...
        public
        function update_site_and_home_url($prefix, $url)
        {
        ...
        public
        function update_user_roles_for_multi_sites($new_prefix_par, $old_prefix_par)
        {
        ...
        public
        function update_user_roles($new_prefix, $old_prefix)
        {
            if (is_multisite()) {
        ...
        public
        function replace_prefix_extra_for_multisite($new_prefix_par, $old_prefix_par)
        {
        ...
        public
        function replace_prefix($new_prefix, $old_prefix)
        {
        ...
        public
        function multi_site_db_changes($new_prefix, $new_site_url, $old_url)
        {
        ...
        public
        function modify_wp_config($meta, $type = false)
        {
            wptc_log(func_get_args(), "--------" . __FUNCTION__ . "--------");
        ...
        private
        function extra_tinkering($line, $type, $meta)
        {
        ...
        private
        function replace_old_cache_path($content, $meta)
        {
            return str_replace($meta['old_path'], $meta['new_path'], $content);
        }

        private
        function reset_Wordfence_config($meta)
        {
        ...
        public
        function remove_unwanted_comment_lines($line, $is_wp_config = false)
        {
        ...
        public
        function replace_htaccess($meta = array())
        {
            wptc_log(func_get_args(), "--------" . __FUNCTION__ . "--------");
            if (empty($meta)) {
                return;
        ...
        private
        function replace_old_cache_in_htaccess_path($meta = array())
        {
