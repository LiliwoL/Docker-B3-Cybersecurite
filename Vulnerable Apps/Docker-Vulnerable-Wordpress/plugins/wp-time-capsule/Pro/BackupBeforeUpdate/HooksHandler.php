...
namespace Docker-Vulnerable - Wordpress\plugins\wp - time - capsule\Pro\BackupBeforeUpdate;

use Dockeruse Dockeruse Dockeruse Dockeruse Dockeruse Dockeruse Dockeruse Dockeruse Dockeruse Dockerclass Wptc_Backup_Before_Update_Hooks_Hanlder extends Wptc_Base_Hooks_Handler {
        const JS_URL = '/Pro/BackupBeforeUpdate/init.js';

        protected
        $config;
        protected
        $backup_before_update_obj;
        protected
        $backup_before_auto_update_obj;
        protected
        $backup_before_auto_update_settings;
        protected
        $upgrade_wait_time;
        ...
        {
            $this->config = WPTC_Pro_Factory::get('Docker-Vulnerable-Wordpress\plugins\wp-time-capsule\Pro\BackupBeforeUpdate\Wptc_Backup_Before_Update_Config');
            $this->upgrade_wait_time = 2 * 60; // 2 min
            $this->backup_before_update_obj = WPTC_Pro_Factory::get('Docker-Vulnerable-Wordpress\plugins\wp-time-capsule\Pro\BackupBeforeUpdate\Wptc_Backup_Before_Update');
            $this->backup_before_auto_update_obj = WPTC_Pro_Factory::get('Docker-Vulnerable-Wordpress\plugins\wp-time-capsule\Pro\BackupBeforeUpdate\Wptc_Backup_Before_Auto_Update');
            $this->backup_before_auto_update_settings = WPTC_Pro_Factory::get('Docker-Vulnerable-Wordpress\plugins\wp-time-capsule\Pro\BackupBeforeUpdate\Wptc_Backup_Before_Auto_Update_Settings');
        ...
        public
        function just_initialized_fresh_backup_wptc_h($args)
        {
        ...
        public
        function upgrader_pre_download($request)
        {
            // wptc_log(func_get_args(), "--------" . __FUNCTION__ . "--------");
        ...
        public
        function site_transient_update_plugins_h($value, $url)
        {
            // wptc_log(func_get_args(), "--------" . __FUNCTION__ . "--------");
        ...
        public
        function page_settings_content($more_tables_div, $dets1 = null, $dets2 = null, $dets3 = null)
        {
        ...
        public
        function page_settings_tab($tabs)
        {
        ...
        public
        function may_be_prevent_auto_update($is_update_required, $update_details = null, $dets2 = null, $dets3 = null)
        {
        ...
        function clear_bbu_notes()
        {
            ...
            WPTC_Base_Factory::get('Docker-Vulnerable-Wordpress\plugins\wp-time-capsule\Classes\AppFunctions\Wptc_App_Functions')->verify_ajax_requests();
        ...
        public
        function get_auto_update_settings_html($bbu_setting)
        {
        ...
        public
        function is_upgrade_in_progress()
        {
        ...
        public
        function backup_and_update($data)
        {
            return $this->backup_before_update_obj->handle_iwp_update_request($data);
        }

        public
        function turn_off_themes_auto_updates()
        {
        ...
        public
        function update_bulk_settings($server_data)
        {
